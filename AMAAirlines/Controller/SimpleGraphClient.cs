...
namespace BotPepe.Controller
{
    ...
    public class SimpleGraphClient
    {
        ...
        public async Task<IListItemsCollectionPage> GetListSP()
        {
            var graphClient = GetAuthenticatedClient();
            var me = await graphClient.Sites["latinshare.sharepoint.com:/sites/dev:"].Lists["Noticias"].Items.Request().Top(5).Expand("Fields($select=Title)").GetAsync();
            var me2 = await graphClient.Sites["latinshare.sharepoint.com:/sites/dev:"].Lists["Noticias"].Items["27"].Request().GetAsync() as ListItem;
            var asd = await graphClient.Sites["latinshare.sharepoint.com:/sites/dev:"].Lists["Noticias"].Request().GetAsync();
        ...
        public async void GetGroups()
        {
            ...
            using (var response = await client.GetAsync("https://graph.microsoft.com/v1.0/sites/latinshare.sharepoint.com:/sites/dev:/lists/Noticias/items?expand=fields(select=*)"))
